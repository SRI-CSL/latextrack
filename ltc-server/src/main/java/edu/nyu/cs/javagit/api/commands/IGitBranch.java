...
public interface IGitBranch {
     ...
     *
     * @param repositoryPath A <code>File</code> instance for the path to the repository. If null is passed,
     *                       a <code>NullPointerException</code> will be thrown.
     * @param options        The options for a git-branch command. If the value is null, a
    ...
    /**
     * Deletes the specified branches using the -d or -D command line option.
     *
     * @param repositoryPath A <code>File</code> instance for the path to the repository. If null is passed,
     *                       a <code>NullPointerException</code> will be thrown.
     * @param forceDelete    True if force delete option -D should be used, false if -d should be used.
     ...
     *                       a <code>NullPointerException</code> will be thrown.
     * @param forceRename    True if force rename option -M should be used. False if -m should be used.
     * @param oldName        When renaming a branch to a different name, this is the old branch name.
     * @param newName        When renaming a branch to a new branch name, this is the new branch name.
     * @return The result of the git branch with -m option.
     * @throws java.io.IOException      There are many reasons for which an <code>IOException</code> may be thrown.
     *                          Examples include:
     *                          <ul>
     ...
     *                       <code>NullPointerException</code> will be thrown.
     * @param branchName     Name of the branch to create.
     * @param startPoint     Start point of the newly created branch.
     * @return The result of the git branch with -m option.
     * @throws java.io.IOException      There are many reasons for which an <code>IOException</code> may be thrown.
     *                          Examples include:
     *                          <ul>
