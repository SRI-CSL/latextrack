...
public class GitBranchOptions {
    ...
    */
     ...
     *
     * @param optVerbose True if the verbose option should be used, false otherwise.
     */
    public void setOptVerbose(boolean optVerbose) {
        checkCanSetNoArgOption("--verbose");
        if ((false == optVerbose) && (optAbbrev || optNoAbbrev)) {
            throw new IllegalArgumentException("Invalid option combination for git-branch command: "
     ...
     *
     * @param commit Commit Ref if the --contains option should be used, null otherwise.
     */
     ...
     *
     * @param option The name of the option being checked; for use in exception messages.
     */
    ...
    public void checkCanSetCreateOption(String option) {
        if (isOptColor() || isOptNoColor() || isOptR() || isOptA() || isOptVerbose() ||
            ...
            throw new IllegalArgumentException("Invalid option combination for git-branch command: " + option +
