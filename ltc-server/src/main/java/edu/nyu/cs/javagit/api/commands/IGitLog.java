...
public interface IGitLog {
    ...
    /**
     * @param repositoryPath A <code>File</code> instance for the path to the repository root (the parent
     ...
     * @throws edu.nyu.cs.javagit.api.JavaGitException Thrown when there is an error executing git log.
     */
    public List<Commit> log(File repositoryPath, GitLogOptions options, String optionalPath)
