...
public class Ref {
    ...
    */
    ...
    static {
        HEAD = new Ref(0, null, RefType.HEAD, null);
        HEAD_1 = new Ref(1, null, RefType.HEAD, null);
    }

    // The type of this ref.
    private final RefType refType;

    // If the ref's type is HEAD, this is the number of commits back from the head of the current working branch.
    private final int headOffset;

    // If the ref's type is BRANCH, REMOTE, SHA1, or TAG, this is the name of the ref.
    private final String name;

    // If the ref's type is REMOTE, this is the name of the remote repository iff a repository name is associated with the remote name.
    private final String repositoryName;

    private Ref(int headOffset, String name, RefType refType, String repositoryName) {
     ...
     *
     * @param name The branch name of this ref. If the value is null, a <code>NullPointerException</code>
    ...
    public static Ref createBranchRef(String name) {
        ...
        return new Ref(-1, name, RefType.BRANCH, null);
    }

    /**
     * Creates a <code>Ref</code> of type <code>HEAD</code>.
     *
     * @param headOffset The offset of the commit back from the HEAD commit on the current working branch. If
    ...
    public static Ref createHeadRef(int headOffset) {
        ...
        return new Ref(headOffset, null, RefType.HEAD, null);
    }

    /**
     * Creates a <code>Ref</code> of type <code>REMOTE</code>.
     *
     * @param repositoryName The remote repository name of this ref. If the value is blank or null, the value will
     *                       be maintained as null.
     * @param name           The remote branch name of this ref. If the value is null, a
    ...
    public static Ref createRemoteRef(String repositoryName, String name) {
        CheckUtilities.checkStringArgument(name, "name");
        return new Ref(-1, name, RefType.REMOTE, repositoryName);
    }

    /**
     * Creates a <code>Ref</code> of type <code>SHA1</code>.
     *
     * @param name The SHA1 name of this ref. The value can be a short name or the full SHA1 value. If
    ...
    public static Ref createSha1Ref(String name) {
        CheckUtilities.checkStringArgument(name, "name");
        return new Ref(-1, name, RefType.SHA1, null);
    }

    /**
     * Creates a <code>Ref</code> of type <code>TAG</code>.
     *
     * @param name The tag name of this ref. If the value is null, a <code>NullPointerException</code>
     *             is thrown. If the value has length zero, an <code>IllegalArgumentException</code> is
     *             thrown.
    ...
    public static Ref createTagRef(String name) {
        CheckUtilities.checkStringArgument(name, "name");
        return new Ref(-1, name, RefType.TAG, null);
    }
