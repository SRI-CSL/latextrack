...
\item[Ltc Command Prefix] This is a global command prefix for all interactive LTC commands in Emacs.  The Emacs convention for modes is to use \Code{\^C} and another character but you can adjust this to your liking if you like to use shortcuts to the LTC functions.
