...
Currently, everything is wrapped into the \Code{LTC-\version.jar} file.  In the future, we may provide packaged applications or even installers for the target platforms.  Let us assume for the remainder of this manual, that you have placed the downloaded jar file into a directory called \Code{\$LTC}. 
