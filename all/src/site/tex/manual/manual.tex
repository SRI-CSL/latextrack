...
This project would not exist without Peter Karp, who had the original idea to bring track changes to the LaTeX world.  My colleagues Grit Denker and Tomer Altman have also been involved in furthering this project.  Recently, Skip Breidbach and Brian Blonski have joined the development effort.  Finally, we thank SRI International to provide the funding to pursue this project.
