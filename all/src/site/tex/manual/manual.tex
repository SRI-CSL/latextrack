...
\usepackage{booktabs,colortbl,tabularx} % tables in publication quality with color etc.
...
\captionsetup{font=small,format=hang,justification=RaggedRight}
...
\newcommand\insertitem[1]{\ $\vartriangleright$\ \fbox{\small #1}}
