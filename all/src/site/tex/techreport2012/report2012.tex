...
\tikzset{%
  ...
  every node/.style={minimum height=2mm},
  match/.style={rectangle,minimum width=2mm,draw=black!70,fill=black!40},
  diff/.style={rectangle,minimum width=2mm,draw=black!70},
  space/.style={myspace,draw=black!70}}
