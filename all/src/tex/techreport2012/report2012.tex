...
% ----- useful packages
\usepackage[letterpaper,verbose,pdftex,margin=1in]{geometry}
...
\tikzset{diffstar/.style = {rectangle,minimum size=#1,draw=black!70,fill=black!20}}
\tikzset{diffstar/.default = \lexemesize}
