...
If we encounter branches in the commit graph, we serialize the parallel changes using the date and time information in the last commit node before the merge commit.  We simply traverse the branch with the earliest commit date.%, as Figure~\ref{fig:example-serialization} depicts.
